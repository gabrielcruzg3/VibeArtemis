...
public:
    ...
    // Apollo & Artemis extensions
    QString fetchClipboard();
    bool uploadClipboard(const QString& text);
    bool executeServerCommand(uint8_t cmdId);
    bool setBitrate(uint32_t bitrateKbps);
    static bool isApolloServer(const QString& serverInfo);
